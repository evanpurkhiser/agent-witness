...
export function ConnectionStatus({status}: {status: ConnectionSnapshot['status']}) {
  ...
  return (
    <div className="flex justify-start">
      <p
        role="status"
        className="border-border bg-surface text-foreground-subtle flex h-7 items-center gap-2 rounded-full border px-3 text-[10px] font-semibold tracking-[0.14em] uppercase shadow-xs"
      >
